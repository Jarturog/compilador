...
public class DescripcionFuncion extends DescripcionSimbolo {
    ...
    // (esta solamente un nivel por debajo de la declaracion de la funcion)
    ...
    public String toString() {
        ...
        params = params.length() > 0 ? "con parametros " + params.substring(0, params.length() - 2) : "sin parametros";
        String etA = variableAsociada == null ? "" : " con etiqueta " + variableAsociada;
        String bytes = getBytes() == null ? "" : " devolviendo " + getBytes() + " bytes";
        return "Funcion tipo " + tipo + " declarada en el nivel " + getNivel() + etA + " " + params;
    }
    ...
    /**
     * Si un if tiene un return y su else tambien, no cuenta para el metodo
